...
8. [Sal_Vs_Temp.py](https://github.com/falkhazam/ece143_final_project/blob/main/Sal_Vs_Temp.py) - salinity vs temperature plots
...
11. [All_plots.ipynb](https://github.com/falkhazam/ece143_final_project/blob/main/All_plots.ipynb) - all of the plots for our project plotted in one file. Note: it may take a while to run because the Argo servers are slow, and we have to pull data from the server.
